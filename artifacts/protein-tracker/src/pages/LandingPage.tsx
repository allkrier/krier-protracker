...
export default function LandingPage() {
  return (
    ...
    >
      ...
      {/* Hero */}
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-24 flex flex-col lg:flex-row items-center gap-14">
        {/* Left copy */}
      ...
      >
        ...
        <p>Food data from OpenFoodFacts. Free and open source.</p>
      </footer>
    </div>
  );
}
